...
data <- cbind(rbind(xTrain, xTest), rbind(yTrain, yTest), rbind(subjectTrain, 
                                                                subjectTest))
...
names(extractedData) <- gsub(pattern="[()]", replacement="", 
                             names(extractedData))
names(extractedData) <- gsub(pattern="\\.+", replacement="_", 
                             names(extractedData))
